...
public abstract class DrawingObject {
    ...
    private ArrayList<Stroke> tileStrokes;
    ...
    /**
     * Adds a specific shape, color, and thickness in the tileShapes, tileColors, and tileStrokes arrays, which will be used in the drawTile method.
     * 
     * @param shape the shape to be added to the tileShapes array
     * @param color the color to be added to the tileColors array
     * @param stroke the thickness to be added to the tileStrokes array
     */
    public void addTile(Shape shape, Color color, Stroke stroke) {
    ...
    /**
     * Another addTile method that can be called without the stroke parameter.
     * This method will be used for shapes that do not contain thickness.
     * 
     * @param shape the shape to be added to the tileShapes array
     * @param color the color to be added to the tileColors array
     */
    public void addTile(Shape shape, Color color) {
        addTile(shape, color, null);
    }
    ...
    public void drawTile(Graphics2D g2d) {
        for (int i = 0; i < tileShapes.size(); i++) {
            ...
            if (tileStrokes.get(i) != null) {
                g2d.setStroke(tileStrokes.get(i));
                g2d.draw(tileShapes.get(i));
            } else {
